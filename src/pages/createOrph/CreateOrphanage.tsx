...
export default function OrphanageData() {
  ...
  async function handleCreateOrph() {
  ...
  async function handleImagePicker() {
    ...
    if(status != 'granted'){
      alert('Necessitamos do acesso à sua galeria para podermos concluir o cadastro!');
      return;
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 24 }}>
      ...
      <RectButton style={styles.nextButton} onPress={handleCreateOrph}>
